...
<head>
    <meta charset="UTF-8">
    <!-- META -->
    <meta name="description" content="Professional cleaning services in Charlottetown, PEI. EasyClean offers tailored cleaning solutions for homes and businesses. Book now for a spotless environment in Prince Edward Island!">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-absolute w-100">
    <div class="container">
        ...
        <a class="navbar-brand" href="../index.php">
            <img src="/images/logo/EasyCleanTransparent.png" alt="EasyClean Logo" class="img-fluid" style="max-height: 100px;"> <!-- Ajusta el tamaño del logo -->
        </a>
